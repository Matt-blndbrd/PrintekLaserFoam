...
namespace PrintekLaserFoam
{
	class GitHub
	{
		...
		public static string installer { get { return System.IO.Path.Combine(GrblCore.TempPath, "PrintekLaserFoam Updater.exe"); } }
		//public static string mainpath = @"PrintekLaserFoam/";
		...
		public static void CleanupOldVersion()
		{
			try
			{
				...
				if (System.IO.File.Exists("PrintekLaserFoam.Settings.bin")) //old setting in program file
					System.IO.File.Delete("PrintekLaserFoam.Settings.bin");
			}
			catch { }
		}
