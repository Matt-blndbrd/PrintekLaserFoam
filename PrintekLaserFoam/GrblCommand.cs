...
namespace PrintekLaserFoam
{
	...
	{
		public static CsvDictionary Settings = new CSV.CsvDictionary("PrintekLaserFoam.CSV.setting_codes.v1.1.csv", 3);
		public static CsvDictionary Alarms = new CSV.CsvDictionary("PrintekLaserFoam.CSV.alarm_codes.csv", 2);
		public static CsvDictionary Errors = new CSV.CsvDictionary("PrintekLaserFoam.CSV.error_codes.csv", 2);

		internal static void LoadAppropriateSettings(GrblCore.GrblVersionInfo value)
		{
			try
			{
				string ResourceName = String.Format("PrintekLaserFoam.CSV.setting_codes.v{0}.{1}.csv", value.Major, value.Minor);
