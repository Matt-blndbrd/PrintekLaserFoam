...
namespace PrintekLaserFoam
{
	...
	public class CustomButtons
	{
		...
		private static string cartelladilavoro = Directory.GetCurrentDirectory();
		private static string filename = System.IO.Path.Combine(cartelladilavoro, "Autotrace/CustomButtons.bin");
