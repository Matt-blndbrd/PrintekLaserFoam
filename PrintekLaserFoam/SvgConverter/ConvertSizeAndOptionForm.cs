...
namespace PrintekLaserFoam.SvgConverter
{
	...
	public partial class SvgToGCodeForm : Form
	{
		...
		public void ShowDialogForm(Form parent)
        {
			...
			IIMaxPower.CurrentValue = (int)Settings.GetObject("GrayScaleConversion.Gcode.LaserOptions.PowerMax", 0);
		...
		{
			System.Diagnostics.Process.Start(@"http://printek.it/laserfoamhelp/usage/raster-image-import/target-image-size-and-laser-options/#laser-modes");
		}

		private void BtnModulationInfo_Click(object sender, EventArgs e)
		{
			System.Diagnostics.Process.Start(@"http://printek.it/laserfoamhelp/usage/raster-image-import/target-image-size-and-laser-options/#power-modulation");
		}
