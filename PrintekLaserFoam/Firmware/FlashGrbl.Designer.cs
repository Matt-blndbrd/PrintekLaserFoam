namespace PrintekLaserFoam
{
	partial class FlashGrbl
	{
		...
		private void InitializeComponent()
		{
			...
			this.BtnTarget = new PrintekLaserFoam.UserControls.ImageButton();
			this.BtnFirmware = new PrintekLaserFoam.UserControls.ImageButton();
	...
	"ble: use at your risk.";
			...
			this.BtnTarget.SizingMode = PrintekLaserFoam.UserControls.ImageButton.SizingModes.FixedSize;
		...
		"...");
			...
			this.BtnFirmware.SizingMode = PrintekLaserFoam.UserControls.ImageButton.SizingModes.FixedSize;
