	...
	public partial class FlashGrbl : Form
	{
		...
		private void InitPortCB() //Availabe Ports combo box
		{
			...
			foreach (string portname in System.IO.Ports.SerialPort.GetPortNames())
			{
				...
				//FIX https://github.com/arkypita/PrintekLaserFoam/issues/31
		...
		{
			System.Diagnostics.Process.Start(@"http://printek.it/laserfoamhelp/usage/flash/#target");
		}

		private void BtnFirmware_Click(object sender, EventArgs e)
		{
			System.Diagnostics.Process.Start(@"http://printek.it/laserfoamhelp/usage/flash/#firmware");
		}
