...
namespace PrintekLaserFoam
{
	partial class ConnectLogForm
	{
		...
		private PrintekLaserFoam.UserControls.GrblTextBox TxtManualCommand;
		private PrintekLaserFoam.UserControls.CommandLog CmdLog;
		private System.Windows.Forms.TextBox TbFileName;
		private PrintekLaserFoam.UserControls.DoubleProgressBar PB;
		private PrintekLaserFoam.UserControls.ImageButton BtnOpen;
		private PrintekLaserFoam.UserControls.ImageButton BtnRunProgram;
		...
		private PrintekLaserFoam.UserControls.ImageButton BtnConnectDisconnect;
		...
		private void InitializeComponent()
		{
			...
			this.TxtManualCommand = new PrintekLaserFoam.UserControls.GrblTextBox();
			this.CmdLog = new PrintekLaserFoam.UserControls.CommandLog();
			this.GBFile = new System.Windows.Forms.Panel();
			this.tableLayoutPanel5 = new System.Windows.Forms.TableLayoutPanel();
			this.LblProgress = new System.Windows.Forms.Label();
			this.LblFilename = new System.Windows.Forms.Label();
			this.TbFileName = new System.Windows.Forms.TextBox();
			this.PB = new PrintekLaserFoam.UserControls.DoubleProgressBar();
			this.BtnOpen = new PrintekLaserFoam.UserControls.ImageButton();
			this.BtnRunProgram = new PrintekLaserFoam.UserControls.ImageButton();
			this.UDLoopCounter = new System.Windows.Forms.NumericUpDown();
			this.BtnAbortProgram = new PrintekLaserFoam.UserControls.ImageButton();
			...
			this.BtnConnectDisconnect = new PrintekLaserFoam.UserControls.ImageButton();
			...
			this.TxtManualCommand.CommandEntered += new PrintekLaserFoam.UserControls.GrblTextBox.CommandEnteredDlg(this.TxtManualCommandCommandEntered);
			...
			this.PB.FillStyle = PrintekLaserFoam.UserControls.FillStyles.Solid;
			...
			this.BtnOpen.SizingMode = PrintekLaserFoam.UserControls.ImageButton.SizingModes.FixedSize;
			...
			this.BtnRunProgram.SizingMode = PrintekLaserFoam.UserControls.ImageButton.SizingModes.FixedSize;
			...
			this.BtnAbortProgram.SizingMode = PrintekLaserFoam.UserControls.ImageButton.SizingModes.FixedSize;
			...
			this.BtnConnectDisconnect.SizingMode = PrintekLaserFoam.UserControls.ImageButton.SizingModes.StretchImage;
