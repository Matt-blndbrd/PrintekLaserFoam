...
namespace PrintekLaserFoam
{
	public partial class SettingsForm : Form
	{
		...
		public SettingsForm(GrblCore core)
		{
            ...
            CbContinuosJog.Checked = (bool)Settings.GetObject("Enable Continuous Jog", true);
		...
		{
			System.Diagnostics.Process.Start(@"http://printek.it/laserfoamhelp/configuration/#pwm-support");
		}

		private void BtnLaserMode_Click(object sender, EventArgs e)
		{
			System.Diagnostics.Process.Start(@"http://printek.it/laserfoamhelp/configuration/#laser-mode");
		}

		private void BtnProtocol_Click(object sender, EventArgs e)
		{
			System.Diagnostics.Process.Start(@"http://printek.it/laserfoamhelp/configuration/#protocol");
		}

		private void BtnStreamingMode_Click(object sender, EventArgs e)
		{
			System.Diagnostics.Process.Start(@"http://printek.it/laserfoamhelp/configuration/#streaming-mode");
		}

		private void BtnThreadingModel_Click(object sender, EventArgs e)
		{
			System.Diagnostics.Process.Start(@"http://printek.it/laserfoamhelp/configuration/#threading-mode");
		}

        private void BtnFType_Click(object sender, EventArgs e)
        {
            System.Diagnostics.Process.Start(@"http://printek.it/laserfoamhelp/configuration/#firmware-type");
        }

        private void CbContinuosJog_CheckedChanged(object sender, EventArgs e)
        {
